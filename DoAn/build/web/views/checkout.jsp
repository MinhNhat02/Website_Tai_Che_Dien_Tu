...
<html lang="en">
    ...
    <div class="section">
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="checkout-form">
                    <div class="section-title">
                        <h3 class="title">Chi tiết đơn hàng thu mua</h3>
            ...
            <div class="col-md-6">
                <div class="shiping-methods">
                    <div class="section-title">
                        <h4 class="title">Phương thức vận chuyển - Tiền vận chuyển sẽ được chúng tôi cộng dồn cho bạn</h4>
                    </div>
            ...
            <f:form id="checkout-form" class="clearfix" action="muahang.htm" commandName="donHang" method="get">
                ...
                <div class="col-md-12">
                    <div class="order-summary clearfix">
                        <div class="section-title">
                            <h3 class="title">Tổng giá trị</h3>
                        </div>
                        <table class="shopping-cart-table table">
                            <tfoot>
                                <tr>
                        ...
                        <div class="pull-right">
                            <f:button onclick="return confirm('Bạn có muốn đăng ký đơn thu mua không')" class="primary-btn">Đăng ký đơn thu mua</f:button>
                            </div>
                        <% } else { %>
                        <div class="pull-right">
        ...
        <h3 class="color">Không có sản phẩm nào trong đơn thu mua</h3>
