...
<div id="top-header">
    <div class="container">
        <div class="pull-left">
            <span>Chào mừng đến với Shop thu mua thiết bị tái chế</span>
        </div>
    </div>
</div>
<div id="header">
            ...
            <ul class="header-btns">
                ...
                <li class="header-account dropdown default-dropdown">
                    ...
                    <ul class="custom-menu">
                        ...
                        <li><a href = "donhangkhachhang.htm?maKh=<%=session.getAttribute("ma")%>"><i class="fa fa-check"></i> Đơn đăng ký thu mua của tôi</a></li>
                        <li><a href = "danhsachuathich.htm?maKh=<%=session.getAttribute("ma")%>"><i class="fa fa-heart-o"></i> Sản phẩm mà bạn lưu</a></li>
                    </ul>
                    <% } else { %>
