                ...
                <div class="product product-details clearfix">
                    ...
                    <div class="col-md-6">
                        <div class="product-body">
                            ...
                            <h3 class="product-price">Giá thu vào : <fmt:formatNumber value="${sanpham.gia}"/> VNĐ</h3>
                            ...
                            <div class="product-btns">
                                ...
                                <button class="primary-btn add-to-cart" ><i class="fa fa-shopping-cart"></i> Thêm vào danh sách thu mua</button>
                            </div>
                            </form>
                        </div>
                    </div>
